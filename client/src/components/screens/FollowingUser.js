            ...
            <div className="card home-card black" key={item._id}>
              <h5>
                {
                  (item.postedBy._id !== state._id)
                    ?
                    <Link to={"/profile/" + item.postedBy._id}> <span style={{ color: 'white' }}>{item.postedBy.name}</span>  </Link>
                    :
                    <Link to="/profile/"><span style={{ color: 'white' }}>{item.postedBy.name}</span></Link>
                }
                {
                  (item.postedBy._id === state._id) ?
              ...
              <div className="card-content">
                ...
                <form onSubmit={(e) => {
                  ...
                  <input type="text" placeholder="add a comment" style={{ color: 'white' }} />
                </form>
              </div>
            </div>
          )
